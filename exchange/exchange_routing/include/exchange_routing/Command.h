...
namespace trading_core {
    /**
     * @class Command
     * @brief An internal representation of a request, converted from an FIX
     * message into this object for faster processing.
     *
     * This is the base class for all commands in the trading system. It
     * provides a common interface for handling different types of requests,
     * such as new orders, modifications, and cancellations.
     */
    class Command {
    public:
        /**
         ...
         */
        Command(const CommandType type, common::ClientID clientId,
        ...
        [[nodiscard]] common::Timestamp getTimestamp() const
        {
            return mTimestamp;
        }
    ...
    private:
        ...
        common::ClientID mClientId; ///< The identifier of the client sending
                                    ///< the command.
        common::Timestamp
                mTimestamp; ///< The timestamp of when the command was created.
    };
} // namespace trading_core
