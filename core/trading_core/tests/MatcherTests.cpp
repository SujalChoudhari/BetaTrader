...
//     {}
//
//     // Override base class methods that interact with the repository to do
//     // nothing
//     void saveState() {}
//     void loadState() {}
//
//     common::TradeID nextId() { return ++mock_current_id; }
//
// private:
...
//         matcher = std::make_unique<trading_core::Matcher>(
...
//                 id, common::Instrument::EURUSD, "test_client", side, type,
...
//     common::Order* incomingBuy
//             = createOrder(2, common::OrderSide::Buy, 100.0, 100);
//     auto trades = matcher->match(incomingBuy, *orderBook);
...
//     common::Order* incomingBuy
//             = createOrder(3, common::OrderSide::Buy, 101.0, 100);
//     auto trades = matcher->match(incomingBuy, *orderBook);
...
//     common::Order* incomingMarketBuy = createOrder(
//             2, common::OrderSide::Buy, 0.0, 100, common::OrderType::Market);
//     auto trades = matcher->match(incomingMarketBuy, *orderBook);
//     ASSERT_EQ(trades.size(), 1);
//     EXPECT_EQ(trades[0].getQuantity(), 70);
//     EXPECT_EQ(incomingMarketBuy->getStatus(),
...
// {
//     common::Order* incomingMarketBuy = createOrder(
//             1, common::OrderSide::Buy, 0.0, 100, common::OrderType::Market);
//     auto trades = matcher->match(incomingMarketBuy, *orderBook);
//     ASSERT_TRUE(trades.empty());
...
//     orderBook->insertOrder(createOrder(1, common::OrderSide::Sell, 100.0, 100));
//     common::Order* incomingBuy
//             = createOrder(2, common::OrderSide::Buy, 105.0, 100);
//     auto trades = matcher->match(incomingBuy, *orderBook);
//     ASSERT_EQ(trades.size(), 1);
//     EXPECT_EQ(trades[0].getPrice(), 100.0);
// }
