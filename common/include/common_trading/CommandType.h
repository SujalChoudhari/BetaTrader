...
namespace trading_core {
    /**
     * @enum CommandType
     * @brief Represents the different types of commands that can be processed
    ...
    constexpr std::array<std::string_view,
                         static_cast<size_t>(CommandType::COUNT)>
            command_type_names = {"NewOrder", "CancelOrder", "ModifyOrder"};
