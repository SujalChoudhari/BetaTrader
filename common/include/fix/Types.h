...
namespace fix {
    ...
    /** @brief Type alias for a price field, inheriting from the common Price type. */
    using Price = common::Price;
    /** @brief Type alias for a quantity field, inheriting from the common Quantity type. */
    using Quantity = common::Quantity;
    /** @brief Type alias for a symbol field, inheriting from the common Symbol type. */
